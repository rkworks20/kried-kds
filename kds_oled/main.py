...
# MicroPython on ESP32-S3  |  v2.0.7
...
# Chicken leg piece icon — 32×32 px (4 bytes/row × 32 rows = 128 bytes)
_chicken_raw = bytes([
...
# Fries icon — 30×32 px (4 bytes/row × 32 rows = 128 bytes)
_fries_raw = bytes([
...
def bill_text_x(bill):
    ...
    return max(0, (128 - text_w) // 2)  # centred across full screen
